...
class SvmIncomeClassifier:
    ...
    def train_and_select_model(self, training_csv, testing_csv):
        ...
        param_set = [
                    	{'kernel': 'rbf', 'C': 4, 'degree': 1, 'gamma': 0.1},
			{'kernel': 'rbf', 'C': 4, 'degree': 1, 'gamma': 0.2},
			{'kernel': 'rbf', 'C': 4, 'degree': 1, 'gamma': 0.3},
                     	{'kernel': 'rbf', 'C': 4, 'degree': 1, 'gamma': 0.4},
                     	{'kernel': 'rbf', 'C': 4, 'degree': 1, 'gamma': 0.5},
	...
	for i in range (0, num_params):
		...
		if tmpscore_test > best_score:
			best_score = tmpscore_test
			best_model = clf0
	print "after fold1, best score = %f, best model = :" % best_score
	print best_model
	...
	for i in range (0, num_params):
		...
		if tmpscore_test > best_score:
			best_score = tmpscore_test
			best_model = clf0
	print "after fold2, best score = %f, best model = :" % best_score
	print best_model
	...
	for i in range (0, num_params):
		...
		if tmpscore_test > best_score:
			best_score = tmpscore_test
			best_model = clf0
	print "after fold3, best score = %f, best model = :" % best_score
	print best_model
	...
	for i in range (0, num_params):
		...
		print "Train average for param:%d, kernel:%s, C:%d, degree:%d..." % (i, param_set[i]["kernel"], param_set[i]["C"], param_set[i]["degree"]) 
		print train_avg[i]
		print "Test average for param:%d, kernel:%s, C:%d, degree:%d..." % (i, param_set[i]["kernel"], param_set[i]["C"], param_set[i]["degree"]) 
		print test_avg[i]
	###return statement########
